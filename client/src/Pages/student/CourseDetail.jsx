  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-32 pt-20 text-left">
        {/* Large smooth gradient background */}
        <div className="absolute top-0 left-0 w-full h-1/2 z-10 bg-gradient-to-b from-cyan-200/70 to-white"></div>
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">Nirmalya</span>
          </p>
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <img
                        className={`transform transition-transform duration-340 ${
        ...
        <div className="max-w-[424px] z-10 shadow-2xl 0px 4px 15px 2px rgba(0, 0, 0, 0.2); rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex gap-3 item-center pt-2">
              ...
              <p className="md:text-sm text-gray-500 line-through">
                ${currency}
                {courseData.coursePrice}
              </p>
