...
function Sidebar() {
  ...
  return isEducator && (
    <div className='md:w-64 w-20 border-r min-h-screen border-gray-500 p-2 flex flex-col gap-2'>
      {
        menuItems.map((item) => {
          return (
            <NavLink
            ...
            >
              ...
              <p className='md:block hidden font-medium whitespace-nowrap'>{item.name}</p>
            </NavLink>
          );
        })
      }
