import React from "react";// <-- Update the path to your image
    ...
    <footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
       <div className="flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10  border-b border-white/20">
        <div className="flex flex-col md:item-start item-center w-full">
          ...
          <p className="mt-6 text-center md:text-left text-sm text-white/70">Unlock your potential with our learning platform. Your journey to growth and success starts here—one lesson at a time.</p>
          </div>
        ...
        <div className="hidden md:flex flex-col item-start w-full">
              ...
              <p className="text-sm text-white/80">The latest news, articles, and resources, sent to <br/> your inbox weekly.</p>
       ...
       <p className="py-4 text-center text-xs md:text-sm text-white/60">Copyright 2025 © Edunova. All Right Reserved.</p>
    </footer>
  );
}
